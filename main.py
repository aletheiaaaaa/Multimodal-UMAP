...
def init_parser() -> argparse.Namespace:
    ...
    parser.add_argument("--train_lr", type=float, default=1.0, help="Training learning rate")
    parser.add_argument("--test_lr", type=float, default=0.1, help="Test/transform learning rate")
